...
class WslSshBridge {
  ...
  static Future<String> setup() async {
    ...
    final password = base64UrlEncode(values).replaceAll('=', '');
    _wslPassword = password;
...
''';
  ...
  static ServerProfile profileFor(String wslUser) {
    if (_wslPassword == null) {
      throw StateError(
        'WSL Bridge setup must be called before creating a profile.',
      );
    }
